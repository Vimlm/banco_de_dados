...
/* Cria a tabela filmes */ -- Unsigned significa não pode valores negativos.
create table filmes(
...
select titulo, genero, ano from filmes where genero = 'Animação' or genero = 'Terror' order by genero, ano;

/* Mostra os filmes de Animação ou Terror. */
select id, titulo, genero, ano from filmes where genero = 'Animação' or genero = 'Terror' order by genero, titulo;
